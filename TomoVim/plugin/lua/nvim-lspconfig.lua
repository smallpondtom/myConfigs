...
local servers = { "pyright", "clangd", "sumneko_lua", "cmake", "julials", "hls", "jsonls", "nimls" }
...
vim.cmd("autocmd CursorMoved * :lua require('diagnostics').echo_diagnostic()")
...
-- If floating window instead of virtual text
